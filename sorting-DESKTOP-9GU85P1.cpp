...
const double coord[18][2] = { { 670, 230 },{ 760, 410 },{ 150, 330 },{ 360, 250 },{ 420, 290 },{ 200, 270 },
{ 150, 100 },{ 840, 350 },{ 910, 250 },{ 890, 190 },{ 740, 450 },{ 280, 360 },
{ 810, 520 },{ 470, 400 },{ 960, 190 },{ 750, 160 },{ 580, 110 },{ 520, 470 } };//Airport coordinates
...
void Flight::draw_flight() {
	...
	//DrawingUtilNG::writeTimesRoman(flight_number, int(x + 10*t), int(y + 10*t), 8);
}
...
void GUI::draw(int *count, int x, int y, int mapw, int maph, int start_time, bool *timeChange[])
{
